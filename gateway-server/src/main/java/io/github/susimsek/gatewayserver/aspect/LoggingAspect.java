package io.github.susimsek.gatewayserver.aspect;
...
public class LoggingAspect {
    ...
    @Pointcut(
        "within(io.github.susimsek.account.repository..*)"
            + " || within(io.github.susimsek.account.service..*)"
            + " || within(io.github.susimsek.account.controller..*)"
    )
