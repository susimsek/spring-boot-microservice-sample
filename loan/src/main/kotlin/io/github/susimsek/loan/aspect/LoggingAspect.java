package io.github.susimsek.loan.aspect;
...
public class LoggingAspect {
    ...
    @Pointcut(
        "within(io.github.susimsek.loan.repository..*)"
            + " || within(io.github.susimsek.loan.service..*)"
            + " || within(io.github.susimsek.loan.controller..*)"
    )
